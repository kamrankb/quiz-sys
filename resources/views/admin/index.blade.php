...
<!-- ============================================================== -->
<div class="row">
  <input type="hidden" class="salespersonid" name="salespersonid" value="{{ isset($salespersonid) ? $salespersonid : '' }}">
  <!-- start page title -->
  <div class="row">
    <div class="col-12">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="mt-4 mt-sm-0">
                <div id="saleTarget-chart" class="apex-charts"></div>
              </div>
            </div>
          </div>
        </div>
...
<script>
  $(document).ready(function () {
       ...
       function salesChart(data){
            ...
            function salesTargetChart(data)
            {
                 ...
                 $("#saleTarget-chart").load(window.location.href + " saleTarget-chart");
                 var chart = new ApexCharts(document.querySelector("#saleTarget-chart"), options);
                 chart.render();
    ...
    // $(document).ready(function() {
        ...
        function fetch_data(from_date = '', to_date = '', week = '', month = '') {
            ...
            $.ajax({
                ...
                type: "post",
                data: {from_date:from_date, to_date:to_date,week:week,month:month,salespersonid:salespersonid,_token:_token},
                success: function (data) {
                    $('#orders').html(data);
            ...
            var table = $('#payments').DataTable({
                ...
                "ajax": {
                    ...
                    "type": "post",
                    "data": {
                        from_date:from_date, to_date:to_date,week:week,month:month,salespersonid:salespersonid,_token:_token
                    },
                },
                aaSorting:[[0,"desc"]],
                columns: [
         ...
         $.ajax({
                ...
                if(salespersonid != ''){
            $.ajax({
                url: route('salesTargetChart_Apidata'),
                type: "post",
                data: {from_date:from_date, to_date:to_date,week:week,month:month,salespersonid:salespersonid,_token:_token},
                success: function (data) {
                  salesTargetChart(data);
                }
            });
          }
