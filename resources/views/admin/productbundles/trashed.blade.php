  ...
  <script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#productBundle').DataTable({
                ajax: route('product-bundle.list.trashed'),
                serverSide: true,
                processing: true,
                aaSorting:[[0,"desc"]],
                columns: [
        ...
        $(document).on('click','.btn-view',function(){
            $.ajax({
                url: route('product-bundle.detail.view',[1]),
                type: "post",
        ...
        $(document).on('click','.btn-product' , function(){
            ...
            $.ajax({
                url: route('product-display.view'),
                type: "post",
                data: {id: $(this).data('id')},
                success: function (data) {
            ...
            $(document).on('click','.btn-restore',function() {
                ...
                $.ajax({
                    url: route('product-bundle.restore'),
                    type: "post",
                    data: {id: $(this).data('id')},
        ...
        $(document).on('click','.btn-delete',function(){
            ...
            Swal.fire({
                ...
                if (t.value) {
                    ...
                    if(!id) return;
                    $.ajax({
                        url: route('product-bundle.delete'),
                        type: "POST",
                        data:{id:id},
                        dataType: 'JSON',
