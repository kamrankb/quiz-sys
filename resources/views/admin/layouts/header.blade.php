        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        @forelse(auth()->user()->unreadNotifications as $notification)
                            @php
                                $performed_by = App\Models\User::find($notification->data['data']['performed_by']);
                            @endphp
                            <a href="#" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-1" key="t-your-order"> {{$performed_by->first_name}} {{$performed_by->last_name }} {{ $notification->data['data']['title']}}</h6>
                    ...
                    <div class="p-2 border-top d-grid">
                        <a class="btn btn-sm btn-link font-size-14 text-center" href="{{route('mark-all-read')}}">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ (!empty($user->image) ? asset($user->image) : asset('/backend/assets/img/users/logo.png') ) }}" alt="Header Avatar">
